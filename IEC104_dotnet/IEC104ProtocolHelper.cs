...
{
    public class IEC104Protocol   /*IEC104 masters play as TCP client role*/
    {
        public delegate void OnIncommingData(IEC104Protocol sender);
        public delegate void OnErrorConnection(IEC104Protocol sender, string message);
        public delegate void OnCommunicationLog(IEC104Protocol sender, bool is_tx_frame, string hexframe);
      ...
      //  private TimerPeriodTask iec104ReceiveHDL;
        ...
        ************************************************************/
        ...
        public IEC104Protocol(string remoteIP, int commonAddr)
        {
            try
            {
        ...
        public IEC104Protocol(string remoteIP, int remotePort, int commonAddr)
