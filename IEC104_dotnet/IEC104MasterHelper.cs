...
{
    public class IEC104MasterHelper   /*IEC104 masters play as TCP client role*/
    {
        public delegate void OnIncommingData(IEC104MasterHelper sender);
        public delegate void OnErrorConnection(IEC104MasterHelper sender, string message);
        public delegate void OnCommunicationLog(IEC104MasterHelper sender, bool is_tx_frame, string hexframe);
        public class TimerPeriodTask
        {

            public delegate void OnPeriodTask(IEC104MasterHelper ctx, int period_ms_eslap);
            ...
            public bool is_timer_loop_wait_task = true;
            public long ms_begin = 0;
            public long ms_end = 0;

            public OnPeriodTask onPeriodTask;
            public IEC104MasterHelper iec104master_helper;
            public long get_total_ms_now()
            {
                return (long)(DateTime.Now - new DateTime(1970, 1, 1)).TotalMilliseconds;
            }
            public TimerPeriodTask(IEC104MasterHelper ctx, int ms)
            {
                this.interval_ms = ms;
                this.iec104master_helper = ctx;
                _timer = new System.Timers.Timer();
                _timer.Interval = this.interval_ms;
                _timer.Elapsed += new System.Timers.ElapsedEventHandler(period_task);
                _timer.Enabled = false;
            }
            public void execute(bool isrun)
            {
                _timer.Enabled = isrun;
            }

            public void period_task(object sender, System.Timers.ElapsedEventArgs e)
            {
                ms_begin = get_total_ms_now();
                int eslap_time = (int)(ms_begin - ms_end);

                if (onPeriodTask != null)
                {
                    if (is_timer_loop_wait_task)
                    {
                        _timer.AutoReset = false;
                        onPeriodTask(iec104master_helper, eslap_time);
                        _timer.Enabled = true;
                    }
                    else
                    {
        ...
        ************************************************************/
        ...
        //==========================================================
        public IEC104MasterHelper(string remoteIP, int commonAddr)
        {
            try
            {
        ...
        public IEC104MasterHelper(string remoteIP, int remotePort, int commonAddr)
        ...
        void iec104_timeout_hdl(IEC104MasterHelper ctx, int ms_eslap)//1 sec timer
        {
        ...
        void iec104_receive_hdl(IEC104MasterHelper ctx, int ms_eslap)//200 ms timer
        {
            int ret = -1;
            try
            {
        ...
        public void disconnect()
        {
            try
            {
                ...
                onCommunicationLog(this, true, "Force To Disconnect TCP");
            }
            catch (Exception e)
            {
                onCommunicationLog(this, true, "Force To Disconnect TCP Err: " + e.Message.ToString());
            }
        }
        ...
        public int parseApdu()
        {
            ...
            switch (apciType_resp)
            {
                ...
                case IEC104_ASDU_Para.ApciType.STARTDT_CON:
                    ...
                    onCommunicationLog(this, false, " receive STARTDT_CON ");
                    break;
                ...
                case IEC104_ASDU_Para.ApciType.I_FORMAT:
                    ...
                    catch (Exception e)
                    {
                        ...
                        onCommunicationLog(this, false, "Invalid Frame format :" + e.Message.ToString());
                        res = -2;
                    }
                    break;
                default:
        ...
        private int parseAsdu()
        {
            ...
            int ioa_begin = idx;
            onCommunicationLog(this, false, "------>> IOA_T  " + ioa_type_id.ToString());
            switch (ioa_type_id)
            {
                ...
                case IEC104_ASDU_Para.IOA_TypeID.C_SC_NA_1: /*confirm from last single cmd request*/
                    if (causeOfTransmission == IEC104_ASDU_Para.COT_Id.ACTIVATION_CON)
                    {
                        ...
                        onCommunicationLog(this, false, "Single CMD ACT confirmation ");
                    }
                    ...
                    if (causeOfTransmission == IEC104_ASDU_Para.COT_Id.ACTIVATION_TERMINATION)
                    {
                        ...
                        onCommunicationLog(this, false, "Single CMD ACT termination ");
                    }
                ...
                case IEC104_ASDU_Para.IOA_TypeID.C_DC_NA_1: /*confirm from last single cmd request*/
                    if (causeOfTransmission == IEC104_ASDU_Para.COT_Id.ACTIVATION_CON)
                    {
                        ...
                        onCommunicationLog(this, false, "Double CMD ACT confirmation ");
                    }

                    if (causeOfTransmission == IEC104_ASDU_Para.COT_Id.ACTIVATION_TERMINATION)
                    {
                        isDoubleCmdConfirmResp = true; //execute task confirm active termination
                        onCommunicationLog(this, false, "Double CMD ACT termination ");
                    }
                ...
                case IEC104_ASDU_Para.IOA_TypeID.C_IC_NA_1:/*cmd interrogation res*/
                    if (causeOfTransmission == IEC104_ASDU_Para.COT_Id.ACTIVATION_TERMINATION)
                    {
                        onCommunicationLog(this, false, "Termination of Interrogation CMD");
                    }
                ...
                case IEC104_ASDU_Para.IOA_TypeID.M_EI_NA_1:/*end of inital*/
                    //   sendSupervisory();
                    onCommunicationLog(this, false, "End of initation : M_EI_NA_1");
                    //Thread.Sleep(500);
                    //  sendInterrogation();
                    break;
                //===========================single point parse========================================
                case IEC104_ASDU_Para.IOA_TypeID.M_SP_NA_1:/*single point without timetag*/
                    ...
                    onCommunicationLog(this, false, "M_SP_NA_1 SinglePoint Recv");
                ...
                case IEC104_ASDU_Para.IOA_TypeID.M_SP_TA_1:/*single point info with timetag CP24Time2a*/
                    ...
                    onCommunicationLog(this, false, "M_SP_TA_1 SinglePoint With Time24");
                    onIncommingData(this);
                ...
                case IEC104_ASDU_Para.IOA_TypeID.M_SP_TB_1:/*single point info with timetag CP56Time2a*/
                    ...
                    onCommunicationLog(this, false, "M_SP_TB_1 SinglePoint With Time56");
                    onIncommingData(this);
                ...
                case IEC104_ASDU_Para.IOA_TypeID.M_DP_NA_1:/*double point without timetag*/
                    ...
                    onCommunicationLog(this, false, "M_DP_NA_1 DoublePoint");
                    onIncommingData(this);
                    break;
                case IEC104_ASDU_Para.IOA_TypeID.M_DP_TA_1:/*double point info with timetag CP24Time2a*/
                    ...
                    onCommunicationLog(this, false, "M_DP_TA_1 DoublePoint With Time24");
                    onIncommingData(this);
                    break;
                case IEC104_ASDU_Para.IOA_TypeID.M_DP_TB_1:/*double point info with timetag CP56Time2a*/
                    ...
                    onCommunicationLog(this, false, "M_DP_TB_1 DoublePoint With Time56");
                    onIncommingData(this);
                    break;
                ...
                case IEC104_ASDU_Para.IOA_TypeID.M_ST_NA_1:/*step pos info without timetag*/
                    ...
                    onCommunicationLog(this, false, "M_ST_NA_1 StepPoint");
                    onIncommingData(this);
                    break;
                case IEC104_ASDU_Para.IOA_TypeID.M_ST_TA_1:/*step pos info with timetag CP24Time2a*/
                    ...
                    onCommunicationLog(this, false, "M_ST_TA_1 StepPoint Time24");
                    onIncommingData(this);
                    break;
                case IEC104_ASDU_Para.IOA_TypeID.M_ST_TB_1:/*step pos info with timetag CP56Time2a*/
                    ...
                    onCommunicationLog(this, false, "M_ST_TB_1 StepPoint Time56");
                    onIncommingData(this);
                    break;
                ...
                case IEC104_ASDU_Para.IOA_TypeID.M_ME_NA_1:/*Measured value,normalized value*/
                    ...
                    onCommunicationLog(this, false, "M_ME_NA_1_MeasuredNormalizedValue");
                    onIncommingData(this);
                    break;
                case IEC104_ASDU_Para.IOA_TypeID.M_ME_TA_1:/*Measured value,normalized value*/
                    ...
                    onCommunicationLog(this, false, "M_ME_TA_1_val Time24");
                    onIncommingData(this);
                ...
                case IEC104_ASDU_Para.IOA_TypeID.M_ME_TD_1:/*Measured value,normalized value*/
                    ...
                    onCommunicationLog(this, false, "M_ME_TD_1_MeasuredNormalizedValueWithTime56");
                    onIncommingData(this);
                    break;
                ...
                case IEC104_ASDU_Para.IOA_TypeID.M_ME_NB_1:/*Measured value,scaled value*/
                    ...
                    onCommunicationLog(this, false, "M_ME_NB_1_MeasuredScaledValue");
                    onIncommingData(this);
                    break;
                case IEC104_ASDU_Para.IOA_TypeID.M_ME_TB_1:/*Measured value,scaled value*/
                    ...
                    onCommunicationLog(this, false, "M_ME_TB_1_MeasuredScaledValueWithTime24");
                    onIncommingData(this);
                    break;
                case IEC104_ASDU_Para.IOA_TypeID.M_ME_TE_1:/*Measured value,scaled value*/
                    ...
                    onCommunicationLog(this, false, "M_ME_TE_1_MeasuredScaledValueWithTime56");
                    onIncommingData(this);
                    break;
                ...
                case IEC104_ASDU_Para.IOA_TypeID.M_ME_NC_1:/*Measured value,Single float value*/
                    ...
                    onCommunicationLog(this, false, "M_ME_NC_1_MeasuredShortFloatingPointValue");
                    onIncommingData(this);
                    break;
                case IEC104_ASDU_Para.IOA_TypeID.M_ME_TC_1:/*Measured value,Single float value*/
                    ...
                    onCommunicationLog(this, false, "M_ME_TC_1_MeasuredShortFloatingPointWithTime24");
                    onIncommingData(this);
                    break;
                case IEC104_ASDU_Para.IOA_TypeID.M_ME_TF_1:/*Measured value,Single float value*/
                    ...
                    onCommunicationLog(this, false, "M_ME_TF_1_MeasuredShortFloatingPointWithTime56");
                    onIncommingData(this);
                    break;
                ...
                case IEC104_ASDU_Para.IOA_TypeID.M_IT_NA_1:/*Integrated val*/
                    ...
                    onCommunicationLog(this, false, "M_IT_NA_1_IntegratedTotalsValue");
                    onIncommingData(this);
                    break;
                ...
                case IEC104_ASDU_Para.IOA_TypeID.M_IT_TB_1:/*Integrated val*/
                    ...
                    onCommunicationLog(this, false, "M_IT_TB_1_IntegratedTotalsValuetWithTime24");
                    onIncommingData(this);
                    break;
                case IEC104_ASDU_Para.IOA_TypeID.M_IT_TA_1:/*Integrated val*/
                    ...
                    onCommunicationLog(this, false, "M_IT_TA_1_IntegratedTotalsValueWithTime56");
                    onIncommingData(this);
                    break;
