...
{
    public class IEC104ProtocolAsync   /*IEC104 masters play as TCP client role*/
    {
        public delegate void OnIncommingData(IEC104ProtocolAsync sender);
        public delegate void OnErrorConnection(IEC104ProtocolAsync sender, string message);
        public delegate void OnCommunicationLog(IEC104ProtocolAsync sender, bool is_tx_frame, string hexframe);
      ...
      //  private TimerPeriodTask iec104ReceiveHDL;
        ...
        ************************************************************/
        ...
        public IEC104ProtocolAsync(string remoteIP, int commonAddr)
        {
            try
            {
        ...
        public IEC104ProtocolAsync(string remoteIP, int remotePort, int commonAddr)
